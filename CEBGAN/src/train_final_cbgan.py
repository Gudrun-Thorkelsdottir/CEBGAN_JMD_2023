...
if __name__ == '__main__':
    ...
    airfoils_opt = np.load('../data/airfoils_opt_train.npy').astype(np.float32)
    inp_paras = np.load('../data/inp_paras_train.npy').astype(np.float32)
    aoas_opt = np.load('../data/aoas_opt_train.npy').astype(np.float32).reshape(-1, 1)
    mean_std = (inp_paras.mean(0), inp_paras.std(0))

    val_airfoils_opt = np.load('../data/airfoils_opt_val.npy').astype(np.float32)
    val_inp_paras = np.load('../data/inp_paras_val.npy').astype(np.float32)
    val_aoas_opt = np.load('../data/aoas_opt_val.npy').astype(np.float32).reshape(-1, 1)
